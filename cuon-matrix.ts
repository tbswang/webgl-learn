...
export class Matrix4 {
  ...
  constructor(opt_src?: {
    ...
    let i: number, s: { [x: string]: any }, d: Float32Array;
    if (
      opt_src &&
   ...
   */
  multiplyVector3(pos: { elements: any }) {
    let e = this.elements;
    let p = pos.elements;
    let v = new Vector3();
   ...
   * @return The result of multiplication(Float32Array)
   */
  multiplyVector4(pos: { elements: any }) {
    let e = this.elements;
    let p = pos.elements;
    let v = new Vector4();
    let result = v.elements;
  ...
  setOrtho(
    ...
    let e: Float32Array | number[], rw: number, rh: number, rd: number;
  ...
  setPerspective(fovy: number, aspect: number, near: number, far: number) {
    let e: Float32Array | number[], rd: number, s: number, ct: number;
   ...
   * @return this
   */
  rotate(angle: any, x: any, y: any, z: any) {
   ...
   * @return this
   */
  dropShadow(plane: any[], light: any[]) {
    let mat = new Matrix4();
    let e = mat.elements;
  ...
  multiply = Matrix4.prototype.concat;
}
